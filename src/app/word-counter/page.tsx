...
import {FileText,Hash,Clock,Eye,BookOpen,Target,TrendingUp,Zap,BarChart3,PieChart,Activity,Sparkles,Copy,Check,RefreshCw,Settings,Star,ArrowRight,MessageSquare,Globe, Minus, Plus,
} from 'lucide-react';
  ...
  const faqData: FAQItem[] = [
    {
      ...
      answer: "One tool that counts the words, characters, sentences, or paragraphs in your text is a word counter."
    },
    {
      id: 2,
      question: "How is the word counter used?",
      answer: "Simply copy and paste your text into the box, and the analytics and count will be displayed automatically."
    },
    {
      id: 3,
      question: "Does it also count spaces?",
      answer: "You can see both because it counts characters with and without spaces."
    },
    {
      id: 4,
      question: "Is it free to use?",
      answer: "The word counter is, in fact, totally free."
    },
    {
      id: 5,
      question: "Is it compatible with mobile devices?",
      answer: "Yes, you can use it on a computer, tablet, or phone."
    },
    {
      id: 6,
      question: "Is my text stored or saved?",
      answer: "Your text is not saved, sorry. It is completely secure and private."
    }
  ];
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
        ...
        <section className="relative z-10 pt-30 pb-16 px-4">
          ...
          Use advanced statistics, readability ratings, and keyword density to evaluate your writing. Ideal for writers,<br></br> social media managers, and content producers.
            </p>
                ...
                <Card className="bg-white/5 backdrop-blur-md border-white/10">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h4 className="text-lg font-semibold text-white">Reading Time</h4>
                    </div>
                    <div className="space-y-3">
                    ...
                    <Card className="bg-white/5 backdrop-blur-md border-white/10">
                      <CardContent className="p-6">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h4 className="text-lg font-semibold text-white">Word Length</h4>
                        </div>
                        <div className="space-y-3">
                          <div>
                    ...
                    <Card className="bg-white/5 backdrop-blur-md border-white/10">
                      <CardContent className="p-6">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h4 className="text-lg font-semibold text-white">Keyword Density</h4>
                        </div>
                        <div className="space-y-2">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
               <h2 className="text-4xl font-bold text-white flex items-center justify-center gap-3">
                          ...
                          />
                          <span className='bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent'>Powerful Text Analysis Features</span>
                        </h2>
                  <p className="mt-3 text-lg font-medium text-pretty text-white sm:text-xl/8 mb-8">
          Strong Text Analysis Features All the tools you need to evaluate and improve your <br></br>writing for maximum effect and more
            </p>
            </div>
            ...
            <div className="text-center mb-16">
               <h2 className="text-4xl font-bold text-white flex items-center justify-center gap-3">
                          <Sparkles
                            className="w-8 h-8 text-yellow-400 animate-pulse animate-spin-slow"
                          />
                          <span className='bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent'>Perfect For Every Content Creator</span>
                        </h2>
                   <p className="mt-3 text-lg font-medium text-pretty text-white sm:text-xl/8 mb-8">
                         Whether you are creating social media content or writing articles, we have<br></br> got you covered
            </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Make your Instagram captions, Twitter conversations, and Facebook posts as interesting as you can.',
                  examples: ['Instagram captions', 'Tweet threads', 'Facebook posts', 'LinkedIn articles']
                },
                {
                  icon: FileText,
                  title: 'Blog Content',
                  description: 'Blog Content Check for readability and SEO enhancements in articles, blog posts, and web content.',
               ...
               <CardHeader className="text-center pb-8">
                        <h2 className="text-4xl font-bold text-white flex items-center justify-center gap-3">
                          <Sparkles
                            className="w-8 h-8 text-yellow-400 animate-pulse animate-spin-slow"
                          />
                          <span className='bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent'>  How to Use the Word Counter</span>
                        </h2>
                        <CardDescription className="mt-3 text-lg font-medium text-pretty text-white sm:text-xl/8 mb-3">
                           Get comprehensive text analysis in just a few simple steps
                        </CardDescription>
                      </CardHeader>
        <section className="relative z-10 py-1 px-4 ">
          <div className="max-w-6xl mx-auto">
            <Card className="bg-gradient-to-br from-white/10 to-white/5 pt-7 backdrop-blur-md border-white/20">
        ...
        {/* CTA Section */}
           <section className="relative z-10 pb-15 px-4 mt-5">
                  <div className="max-w-6xl mx-auto text-center">
